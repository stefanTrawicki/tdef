...
def main(data:dict, force_notune=False):
    return TDEF(job_json=data, force_no_tuning=force_notune)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--notune", action="store_true", help="Whether to force disable tuning (run baseline)", default=False)
